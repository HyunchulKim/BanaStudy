...
process.RandomNumberGeneratorService.g4SimHits.initialSeed = 1 
process.RandomNumberGeneratorService.mix.initialSeed = 1 
process.RandomNumberGeneratorService.mixData.initialSeed = 1 
process.RandomNumberGeneratorService.simSiStripDigis.initialSeed = 1 
process.RandomNumberGeneratorService.simEcalUnsuppressedDigis.initialSeed = 1 
process.RandomNumberGeneratorService.simHcalUnsuppressedDigis.initialSeed = 1 
process.RandomNumberGeneratorService.simMuonDTDigis.initialSeed = 1 
process.RandomNumberGeneratorService.simMuonCSCDigis.initialSeed = 1 
process.RandomNumberGeneratorService.simMuonRPCDigis.initialSeed = 1 
process.RandomNumberGeneratorService.simCastorDigis.initialSeed = 1 
